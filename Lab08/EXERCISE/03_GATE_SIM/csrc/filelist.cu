...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _212243_archive_1.so
_212243_archive_1.so : archive.6/_212243_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_212243_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_212243_archive_1.so $@


ARCHIVE_OBJS += _212276_archive_1.so
_212276_archive_1.so : archive.6/_212276_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_212276_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_212276_archive_1.so $@

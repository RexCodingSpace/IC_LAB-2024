...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _216873_archive_1.so
_216873_archive_1.so : archive.40/_216873_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_216873_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_216873_archive_1.so $@


ARCHIVE_OBJS += _216894_archive_1.so
_216894_archive_1.so : archive.40/_216894_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_216894_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_216894_archive_1.so $@

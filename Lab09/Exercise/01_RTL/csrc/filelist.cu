...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _241351_archive_1.so
_241351_archive_1.so : archive.59/_241351_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_241351_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_241351_archive_1.so $@

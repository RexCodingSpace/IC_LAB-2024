...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _134499_archive_1.so
_134499_archive_1.so : archive.60/_134499_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_134499_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_134499_archive_1.so $@

...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _91189_archive_1.so
_91189_archive_1.so : archive.3/_91189_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_91189_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_91189_archive_1.so $@


ARCHIVE_OBJS += _91404_archive_1.so
_91404_archive_1.so : archive.3/_91404_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_91404_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_91404_archive_1.so $@

...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _138052_archive_1.so
_138052_archive_1.so : archive.108/_138052_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_138052_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_138052_archive_1.so $@

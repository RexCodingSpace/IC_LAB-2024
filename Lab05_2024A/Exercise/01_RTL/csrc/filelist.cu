...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _190254_archive_1.so
_190254_archive_1.so : archive.2/_190254_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_190254_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_190254_archive_1.so $@


ARCHIVE_OBJS += _190275_archive_1.so
_190275_archive_1.so : archive.2/_190275_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_190275_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_190275_archive_1.so $@

...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _5970_archive_1.so
_5970_archive_1.so : archive.12/_5970_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_5970_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_5970_archive_1.so $@


ARCHIVE_OBJS += _5990_archive_1.so
_5990_archive_1.so : archive.12/_5990_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_5990_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_5990_archive_1.so $@

...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _261612_archive_1.so
_261612_archive_1.so : archive.18/_261612_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_261612_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_261612_archive_1.so $@


ARCHIVE_OBJS += _261634_archive_1.so
_261634_archive_1.so : archive.18/_261634_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_261634_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_261634_archive_1.so $@

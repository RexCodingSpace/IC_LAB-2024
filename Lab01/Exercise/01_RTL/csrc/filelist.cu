...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _208689_archive_1.so
_208689_archive_1.so : archive.56/_208689_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_208689_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_208689_archive_1.so $@

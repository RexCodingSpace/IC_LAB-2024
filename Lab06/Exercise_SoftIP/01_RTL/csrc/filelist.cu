...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _260630_archive_1.so
_260630_archive_1.so : archive.49/_260630_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_260630_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_260630_archive_1.so $@


ARCHIVE_OBJS += _260648_archive_1.so
_260648_archive_1.so : archive.49/_260648_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_260648_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_260648_archive_1.so $@
